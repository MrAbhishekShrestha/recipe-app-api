...
def image_upload_url(recipe_id):
    """Create and upload an image upload url."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        self.assertEqual(recipe.links, original_link)
        self.assertEqual(recipe.user, self.user)
    ...
    def test_full_update(self):
        ...
        payload = {
            "title": "New Recipe Title",
            "links": "https://example.com/new-recipe.pdf",
    ...
    def test_create_tag_on_update_recipe(self):
        """Test creating a new tag while updating an existing recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingredient(self):
        """Test creating a new tag when creating a new recipe."""
        payload = {
            "title": "Thai Prawn Curry",
            "time_minutes": 30,
            "price": Decimal("2.50"),
    ...
    def test_create_ingredient_on_update_recipe(self):
        """Test creating a new ingredient while updating an existing recipe."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title="Veg Shawarma")
    ...
    def test_filter_by_ingredients(self):
        """Rest filtering recipes by ingredients."""
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        """Test uploading an invalid image is unsuccessful."""
        url = image_upload_url(self.recipe.id)
